...
const HeroSection = () => (
  <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="absolute inset-0">
      <img src={heroImg} alt="Andaman Islands aerial view" className="w-full h-full object-cover" />
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-primary-foreground leading-tight mb-4">
        Andaman & Nicobar
        <span className="block text-secondary mt-2">Islands</span>
      </h1>
      <p className="text-lg sm:text-xl text-primary-foreground/90 mb-2 font-medium tracking-wide">
        FIND. YOURSELF. HERE
      </p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Button size="lg" className="bg-secondary text-secondary-foreground hover:bg-secondary/90 text-base px-8 shadow-ocean">
