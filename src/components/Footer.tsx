...
const offices = [
  {
    ...
    phone: null,
    mapSrc:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3685.5!2d88.35!3d22.49!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjLCsDI5JzI0LjAiTiA4OMKwMjEnMDAuMCJF!5e0!3m2!1sen!2sin!4v1700000000000",
  },
  {
    ...
    phone: "03192 204936",
    mapSrc:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15542.5!2d92.72!3d11.62!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTHCsDM3JzEyLjAiTiA5MsKwNDMnMTIuMCJF!5e0!3m2!1sen!2sin!4v1700000000000",
  },
];
    ...
    <section className="bg-foreground py-20 px-4">
      <div className="container mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-6 mb-14 max-w-3xl mx-auto">
          {[
            ...
            <a
              key={item.label}
              href={item.href}
              className="flex flex-col items-center gap-3 p-6 rounded-xl bg-primary-foreground/5 border border-primary-foreground/10 hover:bg-primary-foreground/10 transition-colors group"
            >
              <div className="h-11 w-11 rounded-full bg-secondary/20 flex items-center justify-center group-hover:bg-secondary/30 transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {offices.map((office) => (
            <div key={office.name} className="rounded-xl overflow-hidden border border-primary-foreground/10 bg-primary-foreground/5">
              {/* Map */}
